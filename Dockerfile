...
# Copyright (C) 2020 - present Marcel Gediga, Hochschule Karlsruhe
#
...
# Aufruf:   docker build --tag juergenzimmermann/universitaet:2024.04.1-azul .
#               ggf. --progress=plain
#               ggf. --no-cache
...
java -Djarmode=layertools -jar ./build/libs/universitaet-2024.04.0.jar extract

# Maven:
#./mvnw package spring-boot:repackage -Dmaven.test.skip=true -Dspring-boot.build-image.skip=true
#java -Djarmode=layertools -jar ./target/universitaet-2024.04.0.jar extract
EOF
...
LABEL org.opencontainers.image.title="universitaet" \
      org.opencontainers.image.description="Microservice universitaet v1 mit Basis-Image Azul Zulu und Ubuntu Jammy" \
      org.opencontainers.image.version="2024.04.1-azul" \
      org.opencontainers.image.licenses="GPL-3.0-or-later" \
      org.opencontainers.image.vendor="Marcel Gediga" \
      org.opencontainers.image.authors="Marcel.Gediga@h-ka.de" \
