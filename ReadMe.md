...
```powershell
    ...
    docker compose exec postgres bash
        ...
        chmod 400 /var/lib/postgresql/private-key.pem
...
- Bei _Auth URL_ trägt man `http://localhost:8880/realms/spring/protocol/openid-connect/auth` ein.
  Das bei einem GET-Request mit `http://localhost:8880/realms/spring/.well-known/openid-configuration`
  der Wert beim Schlüssel `authorization_endpoint`.
- Bei _Access Token URL_ trägt man `http://localhost:8880/realms/spring/protocol/openid-connect/token` ein.
  Das bei einem GET-Request mit `http://localhost:8880/realms/spring/.well-known/openid-configuration`
