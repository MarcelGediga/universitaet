        ...
        return http
            .authorizeHttpRequests(authorize -> {
                ...
                authorize
                    ...
                    .requestMatchers(GET, restPathUniversitaetId).hasAnyRole(ADMIN.name(), USER.name())
                    .requestMatchers(PUT, restPathUniversitaetId).hasRole(ADMIN.name())
                    .requestMatchers(PATCH, restPathUniversitaetId).hasRole(ADMIN.name())
                    .requestMatchers(DELETE, restPathUniversitaetId).hasRole(ADMIN.name())
