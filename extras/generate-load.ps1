# Copyright (C) 2023 -  Marcel Gediga, Hochschule Karlsruhe
#
...
for ($index = 1; ;$index++) {
  ...
  if ($get) {
    ...
    if ($ingress -ne 'ingress') {
      ...
      $url = "https://kubernetes.docker.internal/universitaeten/rest/$id"
    }
    ...
    if ($ingress -ne 'ingress') {
      ...
      $uri = "https://kubernetes.docker.internal/universitaeten/rest"
    }
